  ...
  return (
    <div className="bg-[#101413] rounded-xl h-[330px] overflow-hidden relative group border-none shadow-xl flex-1">
       ...
       <div className="absolute top-5 left-6 pointer-events-none">
          <span className="text-white font-display font-medium uppercase tracking-widest text-[12px]">
             Geoland Map Preview
          </span>
       </div>
       ...
       <div className="absolute bottom-6 left-6 flex flex-col gap-1 pointer-events-none">
          <h3 className="font-display font-bold uppercase tracking-widest text-[16px] text-white leading-none">
             Geoland Map Preview
          </h3>
          <span className="text-[#A5B3AC] text-[14px] font-body">
